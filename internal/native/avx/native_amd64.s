...
LBB2_7:
	...
	LEAQ 16(DX)(AX*1), R8
	ANDL $15, CX
	QUAD $0xffffff42056ffac5 // vmovdqu      $-190(%rip), %xmm0  /* LCPI2_0(%rip) */
	QUAD $0xffffff4a0d6ffac5 // vmovdqu      $-182(%rip), %xmm1  /* LCPI2_1(%rip) */
	QUAD $0xffffff52156ffac5 // vmovdqu      $-174(%rip), %xmm2  /* LCPI2_2(%rip) */
	QUAD $0xffffff5a1d6ffac5 // vmovdqu      $-166(%rip), %xmm3  /* LCPI2_3(%rip) */
...
LBB3_5:
	...
	INCL    DX
	MOVL    $348, R14
	LONG    $0x9c0d8d48; WORD $0x0079; BYTE $0x00 // leaq         $31132(%rip), %rcx  /* _TabPowE(%rip) */
	MOVWLSX 0(CX)(DX*2), SI
	LONG    $0x3f0d8d48; WORD $0x007a; BYTE $0x00 // leaq         $31295(%rip), %rcx  /* _TabPowF(%rip) */
	MOVQ    0(CX)(DX*8), R8
	BSRQ    AX, CX
	XORL    $63, CX
	SHLQ    CX, AX
...
LBB3_21:
	...
	JB    LBB3_22
	WORD  $0x9848                               // cltq
	LONG  $0xdb0d8d48; WORD $0x0079; BYTE $0x00 // leaq         $31195(%rip), %rcx  /* _TabPow10(%rip) */
	MOVQ  -80(BP), SI
	IMULQ 0(CX)(AX*8), SI
	CMPQ  R12, SI
	MOVQ  -64(BP), R13
...
LBB3_38:
	MOVL R10, CX
	LONG $0x71158d48; WORD $0x0079; BYTE $0x00 // leaq         $31089(%rip), %rdx  /* _TabPow10(%rip) */
	MOVQ 0(DX)(CX*8), SI
	MOVL R15, CX
	SHLQ CX, SI
	MOVQ -80(BP), R8
...
LBB3_120:
	...
	ADDL    $2, AX
	MOVLQSX DI, CX
	LONG    $0xb5158d48; WORD $0x0074; BYTE $0x00 // leaq         $29877(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*2), BX
	ADDQ    CX, CX
	MOVB    BX, 0(SI)
	MOVLQSX CX, CX
...
LBB3_122:
	...
	SUBL   CX, DI
	LONG   $0x730d8d48; WORD $0x0073; BYTE $0x00 // leaq         $29555(%rip), %rcx  /* _Digits(%rip) */
	MOVB   0(CX)(DI*2), DX
	MOVB   1(CX)(DI*2), CX
	MOVB   DX, 1(SI)
	MOVB   CX, 2(SI)
...
LBB3_110:
	...
	ADDL    $4, AX
	MOVLQSX DI, CX
	LONG    $0x48358d48; WORD $0x0073; BYTE $0x00 // leaq         $29512(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(SI)(CX*2), BX
	ADDQ    CX, CX
	MOVB    BX, 0(DX)
	MOVLQSX CX, CX
...
LBB3_112:
	...
	WORD   $0xc96b; BYTE $0x64                   // imull        $100, %ecx, %ecx
	SUBL   CX, DI
	LONG   $0x0f0d8d48; WORD $0x0073; BYTE $0x00 // leaq         $29455(%rip), %rcx  /* _Digits(%rip) */
	MOVB   0(CX)(DI*2), BX
	MOVB   1(CX)(DI*2), CX
	MOVB   BX, 1(DX)
	MOVB   CX, 2(DX)
...
_u64toa:
	...
	CMPL    SI, $1000
	JB      LBB5_3
	LONG    $0xd60d8d48; WORD $0x0071; BYTE $0x00 // leaq         $29142(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(DX)(CX*1), CX
	MOVB    CX, 0(DI)
	MOVL    $1, CX
	JMP     LBB5_4
...
LBB5_4:
	MOVWLZX DX, DX
	ORQ     $1, DX
	LONG    $0xb5358d48; WORD $0x0071; BYTE $0x00 // leaq         $29109(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(DX)(SI*1), DX
	MOVL    CX, SI
	INCL    CX
	MOVB    DX, 0(DI)(SI*1)
...
LBB5_6:
	LONG $0xa4158d48; WORD $0x0071; BYTE $0x00 // leaq         $29092(%rip), %rdx  /* _Digits(%rip) */
	MOVB 0(AX)(DX*1), DX
	MOVL CX, SI
	INCL CX
	MOVB DX, 0(DI)(SI*1)
...
LBB5_7:
	MOVWLZX AX, AX
	ORQ     $1, AX
	LONG    $0x8c158d48; WORD $0x0071; BYTE $0x00 // leaq         $29068(%rip), %rdx  /* _Digits(%rip) */
	MOVB    0(AX)(DX*1), AX
	MOVL    CX, DX
	INCL    CX
	MOVB    AX, 0(DI)(DX*1)
...
LBB5_8:
	...
	CMPL    SI, $10000000
	JB      LBB5_11
	LONG    $0xf5058d48; WORD $0x0070; BYTE $0x00 // leaq         $28917(%rip), %rax  /* _Digits(%rip) */
	MOVB    0(R10)(AX*1), AX
	MOVB    AX, 0(DI)
	MOVL    $1, CX
	JMP     LBB5_12
...
LBB5_12:
	MOVL R10, AX
	ORQ  $1, AX
	LONG $0xd0358d48; WORD $0x0070; BYTE $0x00 // leaq         $28880(%rip), %rsi  /* _Digits(%rip) */
	MOVB 0(AX)(SI*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB5_14:
	LONG $0xbf058d48; WORD $0x0070; BYTE $0x00 // leaq         $28863(%rip), %rax  /* _Digits(%rip) */
	MOVB 0(R9)(AX*1), AX
	MOVL CX, SI
	INCL CX
	MOVB AX, 0(DI)(SI*1)
...
LBB5_15:
	MOVWLZX R9, AX
	ORQ     $1, AX
	LONG    $0xa5358d48; WORD $0x0070; BYTE $0x00 // leaq         $28837(%rip), %rsi  /* _Digits(%rip) */
	MOVB    0(AX)(SI*1), AX
	MOVL    CX, DX
	MOVB    AX, 0(DX)(DI*1)
	MOVB    0(R8)(SI*1), AX
...
LBB5_16:
	...
	QUAD $0xfffffdc51512fbc5                   // vmovddup     $-571(%rip), %xmm2  /* LCPI5_1(%rip) */
	LONG $0xc2e4f9c5                           // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffffdc12512fbc5                   // vmovddup     $-575(%rip), %xmm4  /* LCPI5_2(%rip) */
	LONG $0xc4e4f9c5                           // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffd8d2d6ffac5                   // vmovdqu      $-627(%rip), %xmm5  /* LCPI5_3(%rip) */
	...
	QUAD $0xfffffd470dfcf9c5                   // vpaddb       $-697(%rip), %xmm0, %xmm1  /* LCPI5_4(%rip) */
	...
	SUBL AX, CX
	SHLQ $4, AX
	LONG $0x1a158d48; WORD $0x0070; BYTE $0x00 // leaq         $28698(%rip), %rdx  /* _VecShiftShuffles(%rip) */
...
LBB5_20:
	...
	JA   LBB5_22
	MOVL DX, AX
	LONG $0xfd0d8d48; WORD $0x006e; BYTE $0x00 // leaq         $28413(%rip), %rcx  /* _Digits(%rip) */
	MOVB 0(CX)(AX*2), DX
	MOVB 1(CX)(AX*2), AX
	MOVB DX, 0(DI)
	MOVB AX, 1(DI)
...
LBB5_22:
	...
	SUBL    CX, AX
	MOVWLZX AX, AX
	LONG    $0xac0d8d48; WORD $0x006e; BYTE $0x00 // leaq         $28332(%rip), %rcx  /* _Digits(%rip) */
	MOVB    0(CX)(AX*2), DX
	MOVB    1(CX)(AX*2), AX
	MOVB    DX, 1(DI)
	MOVB    AX, 2(DI)
...
LBB5_24:
	...
	SUBL    CX, DX
	MOVWLZX AX, AX
	LONG    $0x89058d4c; WORD $0x006e; BYTE $0x00 // leaq         $28297(%rip), %r8  /* _Digits(%rip) */
	MOVB    0(R8)(AX*2), CX
	MOVB    1(R8)(AX*2), AX
	MOVB    CX, 0(DI)
	MOVB    AX, 1(DI)
...
LBB5_25:
	...
	SHRQ $26, DX
	LONG $0xc26ef9c5               // vmovd        %edx, %xmm0
	QUAD $0xfffffbe60d6ffac5       // vmovdqu      $-1050(%rip), %xmm1  /* LCPI5_0(%rip) */
	LONG $0xd1f4f9c5               // vpmuludq     %xmm1, %xmm0, %xmm2
	LONG $0xd273e9c5; BYTE $0x2d   // vpsrlq       $45, %xmm2, %xmm2
	MOVL $10000, AX
	LONG $0x6ef9e1c4; BYTE $0xd8   // vmovq        %rax, %xmm3
	...
	LONG $0xc070fbc5; BYTE $0x50   // vpshuflw     $80, %xmm0, %xmm0
	LONG $0xc070f9c5; BYTE $0x50   // vpshufd      $80, %xmm0, %xmm0
	QUAD $0xfffffbe01512fbc5       // vmovddup     $-1056(%rip), %xmm2  /* LCPI5_1(%rip) */
	LONG $0xc2e4f9c5               // vpmulhuw     %xmm2, %xmm0, %xmm0
	QUAD $0xfffffbdc2512fbc5       // vmovddup     $-1060(%rip), %xmm4  /* LCPI5_2(%rip) */
	LONG $0xc4e4f9c5               // vpmulhuw     %xmm4, %xmm0, %xmm0
	QUAD $0xfffffba82d6ffac5       // vmovdqu      $-1112(%rip), %xmm5  /* LCPI5_3(%rip) */
	LONG $0xf5d5f9c5               // vpmullw      %xmm5, %xmm0, %xmm6
	LONG $0xf673c9c5; BYTE $0x10   // vpsllq       $16, %xmm6, %xmm6
	LONG $0xc6f9f9c5               // vpsubw       %xmm6, %xmm0, %xmm0
	LONG $0xe100c269; WORD $0x05f5 // imull        $100000000, %edx, %eax
	...
	LONG $0xcaf9f1c5               // vpsubw       %xmm2, %xmm1, %xmm1
	LONG $0xc167f9c5               // vpackuswb    %xmm1, %xmm0, %xmm0
	QUAD $0xfffffb5a05fcf9c5       // vpaddb       $-1190(%rip), %xmm0, %xmm0  /* LCPI5_4(%rip) */
	MOVL CX, AX
...
_quote:
	...
	MOVQ  CX, R12
	TESTB $1, R8
	LONG  $0x8b058d48; WORD $0x006e; BYTE $0x00 // leaq         $28299(%rip), %rax  /* __SingleQuoteTab(%rip) */
	LONG  $0x84158d4c; WORD $0x007e; BYTE $0x00 // leaq         $32388(%rip), %r10  /* __DoubleQuoteTab(%rip) */
	...
	MOVQ  SI, CX
	MOVQ  0(R12), R9
	QUAD  $0xffffff88056ffac5                   // vmovdqu      $-120(%rip), %xmm0  /* LCPI6_0(%rip) */
	QUAD  $0xffffff900d6ffac5                   // vmovdqu      $-112(%rip), %xmm1  /* LCPI6_1(%rip) */
	QUAD  $0xffffff98156ffac5                   // vmovdqu      $-104(%rip), %xmm2  /* LCPI6_2(%rip) */
...
LBB6_12:
	...
	JLE   LBB6_17
	TESTQ SI, SI
	LONG  $0x38158d48; WORD $0x006d; BYTE $0x00 // leaq         $27960(%rip), %rdx  /* __SingleQuoteTab(%rip) */
	JLE   LBB6_17
...
_unquote:
	...
	MOVL  R8, R10
	ANDL  $1, R10
	LONG  $0xd2058d4c; WORD $0x008a; BYTE $0x00 // leaq         $35538(%rip), %r8  /* __UnquoteTab(%rip) */
	QUAD  $0xffffffb5056ffac5                   // vmovdqu      $-75(%rip), %xmm0  /* LCPI7_0(%rip) */
	MOVQ  DI, R9
	MOVQ  SI, R14
	MOVQ  DX, AX
...
_atof_eisel_lemire64:
	...
	MOVQ    DI, BX
	MOVQ    CX, -48(BP)
	LONG    $0x0031eee8; BYTE $0x00               // callq        _count_len_u64
	MOVL    AX, R8
	MOVL    AX, CX
	NEGL    CX
	SHLQ    CX, BX
	MOVL    R14, CX
	SHLQ    $4, CX
	LONG    $0x9b158d4c; WORD $0x0033; BYTE $0x00 // leaq         $13211(%rip), %r10  /* _POW10_M128_TAB(%rip) */
	MOVQ    BX, AX
	MULQ    8(CX)(R10*1)
	MOVQ    AX, R9
	MOVQ    DX, DI
...
LBB9_8:
	MOVQ R13, DI
	LONG $0x003065e8; BYTE $0x00 // callq        _left_shift
	MOVQ -64(BP), R11
	MOVQ -72(BP), R10
	MOVQ -48(BP), R9
...
LBB9_10:
	...
	JG   LBB9_12
	MOVL AX, AX
	LONG $0x360d8d48; WORD $0x005d; BYTE $0x00 // leaq         $23862(%rip), %rcx  /* _POW_TAB(%rip) */
	MOVL 0(CX)(AX*4), R10
...
LBB9_43:
	...
	MOVQ R9, -48(BP)
	JG   LBB9_7
	LONG $0xcc158d4c; WORD $0x0082; BYTE $0x00 // leaq         $33484(%rip), %r10  /* _LSHIFT_TAB(%rip) */
	JMP  LBB9_48
...
LBB9_88:
	LONG $0x0e0d8d4c; WORD $0x0059; BYTE $0x00 // leaq         $22798(%rip), %r9  /* _POW_TAB(%rip) */
	JMP  LBB9_92

LBB9_89:
	MOVQ R13, DI
	LONG $0x002c02e8; BYTE $0x00               // callq        _left_shift
	MOVQ -64(BP), R11
	MOVQ -72(BP), R10
	LONG $0xf50d8d4c; WORD $0x0058; BYTE $0x00 // leaq         $22773(%rip), %r9  /* _POW_TAB(%rip) */
...
LBB9_97:
	...
	MOVL  DI, SI
	CMPL  DI, $61
	LONG  $0xd0158d4c; WORD $0x007f; BYTE $0x00 // leaq         $32720(%rip), %r10  /* _LSHIFT_TAB(%rip) */
	JL    LBB9_89
	MOVL  -48(BP), CX
	MOVL  CX, R8
	JMP   LBB9_105
...
LBB9_133:
	...
	CMPQ    DI, SI
	JL      LBB9_133
	LONG    $0x390d8d4c; WORD $0x0055; BYTE $0x00 // leaq         $21817(%rip), %r9  /* _POW_TAB(%rip) */
	JMP     LBB9_136
...
LBB9_202:
	...
	MOVL 0(R14), R11
	MOVL R10, R9
	LONG $0x4f158d4c; WORD $0x007a; BYTE $0x00 // leaq         $31311(%rip), %r10  /* _LSHIFT_TAB(%rip) */
	JMP  LBB9_223
...
LBB9_204:
	...
	XORL    BX, BX
	XORL    AX, AX
	LONG    $0x37158d4c; WORD $0x007a; BYTE $0x00 // leaq         $31287(%rip), %r10  /* _LSHIFT_TAB(%rip) */
...
LBB9_239:
	...
	CMPL  CX, $801
	MOVL  $800, R11
	LONG  $0xd94c0f44        // cmovll       %ecx, %r11d
	MOVL  R11, 0(R14)
	MOVQ  -64(BP), AX
	ADDL  R8, 0(AX)
	TESTL CX, CX
...
LBB10_32:
	...
	LEAQ -24(BP), SI
	WORD $0xf8c5; BYTE $0x77     // vzeroupper
	LONG $0xffee5be8; BYTE $0xff // callq        _decimal_to_f64
...
LBB11_26:
	...
	LEAQ 16(SI)(CX*1), SI
	ANDL $15, AX
	QUAD $0xfffffe88056ffac5 // vmovdqu      $-376(%rip), %xmm0  /* LCPI11_0(%rip) */
	QUAD $0xfffffe900d6ffac5 // vmovdqu      $-368(%rip), %xmm1  /* LCPI11_1(%rip) */
	QUAD $0xfffffe98156ffac5 // vmovdqu      $-360(%rip), %xmm2  /* LCPI11_2(%rip) */
	QUAD $0xfffffea01d6ffac5 // vmovdqu      $-352(%rip), %xmm3  /* LCPI11_3(%rip) */
...
LBB11_41:
	...
	CMPL    CX, $125
	JA      LBB11_44
	LONG    $0x3c158d48; WORD $0x0002; BYTE $0x00 // leaq         $572(%rip), %rdx  /* LJTI11_0(%rip) */
...
LBB11_43:
	...
	LEAQ -40(BP), SI
	MOVQ R14, DX
	LONG $0x000910e8; BYTE $0x00 // callq        _vnumber
	MOVQ -40(BP), AX
	JMP  LBB11_82
...
LBB11_45:
	...
	MOVQ  R15, SI
	MOVQ  R12, DX
	LONG  $0x000481e8; BYTE $0x00 // callq        _advance_string
	TESTQ AX, AX
	JS    LBB11_64
	MOVQ  AX, -40(BP)
	MOVQ  R12, 16(R14)
...
// .set L11_0_set_80, LBB11_80-LJTI11_0
...
LJTI11_0:
	LONG $0xffffffe9 // .long L11_0_set_80
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	...
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdf6 // .long L11_0_set_45
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	...
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffe41 // .long L11_0_set_47
	LONG $0xfffffdcd // .long L11_0_set_43
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdcd // .long L11_0_set_43
	LONG $0xfffffdcd // .long L11_0_set_43
	...
	LONG $0xfffffdcd // .long L11_0_set_43
	LONG $0xfffffdcd // .long L11_0_set_43
	LONG $0xfffffe53 // .long L11_0_set_48
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	...
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffe65 // .long L11_0_set_49
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffed8 // .long L11_0_set_57
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	...
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffefb // .long L11_0_set_59
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	...
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffe71 // .long L11_0_set_50
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffe9f // .long L11_0_set_53
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xffffff30 // .long L11_0_set_63
	LONG $0xfffffdea // .long L11_0_set_44
	LONG $0xfffffec9 // .long L11_0_set_56
...
LBB14_1:
	LEAQ  -24(BP), CX
	LONG  $0xffe224e8; BYTE $0xff // callq        _atof_eisel_lemire64
	TESTL AX, AX
	JE    LBB14_7
	LONG  $0x4510fbc5; BYTE $0xe8 // vmovsd       $-24(%rbp), %xmm0
	JMP   LBB14_16
...
LBB14_3:
	...
	JL      LBB14_11
	MOVLQSX SI, AX
	LONG    $0x080d8d48; WORD $0x0128; BYTE $0x00 // leaq         $75784(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB14_7:
	...
	MOVL 8(BX), SI
	SUBL R14, SI
	LONG $0xfff287e8; BYTE $0xff // callq        _atof_native_decimal
	JMP  LBB14_16
...
LBB14_9:
	...
	NEGL    SI
	MOVLQSX SI, AX
	LONG    $0xd00d8d48; WORD $0x0127; BYTE $0x00 // leaq         $75728(%rip), %rcx  /* _P10_TAB(%rip) */
...
LBB14_12:
	...
	JA   LBB14_1
	MOVL AX, AX
	LONG $0x9e0d8d48; WORD $0x0127; BYTE $0x00 // leaq         $75678(%rip), %rcx  /* _P10_TAB(%rip) */
...
_fsm_exec:
	...
	MOVQ  $-1, R13
	MOVQ  $4294977024, R14
	QUAD  $0xffffff7c1d6ffac5 // vmovdqu      $-132(%rip), %xmm3  /* LCPI19_0(%rip) */
	QUAD  $0xffffff84256ffac5 // vmovdqu      $-124(%rip), %xmm4  /* LCPI19_1(%rip) */
	QUAD  $0xffffff8c2d6ffac5 // vmovdqu      $-116(%rip), %xmm5  /* LCPI19_2(%rip) */
	QUAD  $0xffffff94356ffac5 // vmovdqu      $-108(%rip), %xmm6  /* LCPI19_3(%rip) */
	MOVQ  R12, R8
	MOVQ  DI, -56(BP)
	JMP   LBB19_7
...
LBB19_50:
	...
	JA      LBB19_54
	LEAQ    -1(SI), R9
	LONG    $0x3b1d8d48; WORD $0x0004; BYTE $0x00 // leaq         $1083(%rip), %rbx  /* LJTI19_0(%rip) */
...
LBB19_60:
	...
	MOVQ  R12, DX
	LEAQ  -72(BP), CX
	LONG  $0xfff31ae8; BYTE $0xff // callq        _advance_string
	MOVQ  AX, CX
	TESTQ AX, AX
	JS    LBB19_91
...
LBB19_61:
	...
	MOVQ  R15, AX
	TESTQ R12, R12
	QUAD  $0xfffffc931d6ffac5 // vmovdqu      $-877(%rip), %xmm3  /* LCPI19_0(%rip) */
	QUAD  $0xfffffc9b256ffac5 // vmovdqu      $-869(%rip), %xmm4  /* LCPI19_1(%rip) */
	QUAD  $0xfffffca32d6ffac5 // vmovdqu      $-861(%rip), %xmm5  /* LCPI19_2(%rip) */
	QUAD  $0xfffffcab356ffac5 // vmovdqu      $-853(%rip), %xmm6  /* LCPI19_3(%rip) */
	JG    LBB19_5
	JMP   LBB19_98
...
LBB19_66:
	MOVQ    $-1, AX
	LONG    $0x34158d48; WORD $0x0003; BYTE $0x00 // leaq         $820(%rip), %rdx  /* LJTI19_1(%rip) */
	MOVLQSX 0(DX)(CX*4), CX
	ADDQ    DX, CX
	JMP     CX
...
LBB19_67:
	...
	MOVQ  8(AX), SI
	SUBQ  R15, SI
	LONG  $0x000650e8; BYTE $0x00 // callq        _skip_number
	QUAD  $0xfffffc33356ffac5     // vmovdqu      $-973(%rip), %xmm6  /* LCPI19_3(%rip) */
	QUAD  $0xfffffc1b2d6ffac5     // vmovdqu      $-997(%rip), %xmm5  /* LCPI19_2(%rip) */
	QUAD  $0xfffffc03256ffac5     // vmovdqu      $-1021(%rip), %xmm4  /* LCPI19_1(%rip) */
	QUAD  $0xfffffbeb1d6ffac5     // vmovdqu      $-1045(%rip), %xmm3  /* LCPI19_0(%rip) */
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
	LEAQ  -1(AX), CX
	LONG  $0xca480f48             // cmovsq       %rdx, %rcx
	MOVQ  $-2, AX
...
LBB19_71:
	...
	MOVQ    R12, DX
	LEAQ    -72(BP), CX
	LONG    $0xfff1c5e8; BYTE $0xff // callq        _advance_string
	MOVQ    AX, CX
	TESTQ   AX, AX
	JS      LBB19_91
	MOVQ    -48(BP), AX
	...
	MOVQ    R15, AX
	TESTQ   R12, R12
	QUAD    $0xfffffb411d6ffac5     // vmovdqu      $-1215(%rip), %xmm3  /* LCPI19_0(%rip) */
	QUAD    $0xfffffb49256ffac5     // vmovdqu      $-1207(%rip), %xmm4  /* LCPI19_1(%rip) */
	QUAD    $0xfffffb512d6ffac5     // vmovdqu      $-1199(%rip), %xmm5  /* LCPI19_2(%rip) */
	QUAD    $0xfffffb59356ffac5     // vmovdqu      $-1191(%rip), %xmm6  /* LCPI19_3(%rip) */
	JLE     LBB19_98
	MOVLQSX 0(BX), AX
	CMPQ    AX, $65535
	JG      LBB19_92
...
// .set L19_0_set_52, LBB19_52-LJTI19_0
// .set L19_0_set_55, LBB19_55-LJTI19_0
// .set L19_0_set_58, LBB19_58-LJTI19_0
// .set L19_0_set_62, LBB19_62-LJTI19_0
// .set L19_0_set_64, LBB19_64-LJTI19_0
// .set L19_0_set_68, LBB19_68-LJTI19_0
LJTI19_0:
	LONG $0xfffffbce // .long L19_0_set_52
	LONG $0xfffffbfb // .long L19_0_set_55
	LONG $0xfffffc2b // .long L19_0_set_58
	LONG $0xfffffc9b // .long L19_0_set_62
	LONG $0xfffffcb5 // .long L19_0_set_64
	LONG $0xfffffd5e // .long L19_0_set_68

	// .set L19_1_set_98, LBB19_98-LJTI19_1
	...
	// .set L19_1_set_77, LBB19_77-LJTI19_1
	// .set L19_1_set_79, LBB19_79-LJTI19_1
	// .set L19_1_set_82, LBB19_82-LJTI19_1
	// .set L19_1_set_84, LBB19_84-LJTI19_1
	// .set L19_1_set_88, LBB19_88-LJTI19_1
LJTI19_1:
	LONG $0xffffff45 // .long L19_1_set_98
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	...
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffc28 // .long L19_1_set_60
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	...
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffdf4 // .long L19_1_set_75
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffcd5 // .long L19_1_set_67
	LONG $0xfffffcd5 // .long L19_1_set_67
	LONG $0xfffffcd5 // .long L19_1_set_67
	LONG $0xfffffcd5 // .long L19_1_set_67
	LONG $0xfffffcd5 // .long L19_1_set_67
	...
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffe1b // .long L19_1_set_77
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	...
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffe3c // .long L19_1_set_79
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	...
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffe68 // .long L19_1_set_82
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffe8d // .long L19_1_set_84
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xffffff3e // .long L19_1_set_97
	LONG $0xfffffece // .long L19_1_set_88
...
_skip_string:
	...
	LEAQ  -32(BP), CX
	MOVQ  BX, DX
	LONG  $0xffecfae8; BYTE $0xff // callq        _advance_string
	TESTQ AX, AX
	JS    LBB22_2
	DECQ  BX
	MOVQ  AX, CX
...
LBB24_4:
	...
	ADDQ DI, R11
	MOVQ $-1, R10
	QUAD $0xffffff3b056f7ac5 // vmovdqu      $-197(%rip), %xmm8  /* LCPI24_0(%rip) */
	QUAD $0xffffff430d6f7ac5 // vmovdqu      $-189(%rip), %xmm9  /* LCPI24_1(%rip) */
	QUAD $0xffffff4b156f7ac5 // vmovdqu      $-181(%rip), %xmm10  /* LCPI24_2(%rip) */
	QUAD $0xffffff531d6f7ac5 // vmovdqu      $-173(%rip), %xmm11  /* LCPI24_3(%rip) */
	QUAD $0xffffff5b256ffac5 // vmovdqu      $-165(%rip), %xmm4  /* LCPI24_4(%rip) */
	QUAD $0xffffff632d6ffac5 // vmovdqu      $-157(%rip), %xmm5  /* LCPI24_5(%rip) */
	QUAD $0xffffff6b356ffac5 // vmovdqu      $-149(%rip), %xmm6  /* LCPI24_6(%rip) */
	MOVL $4294967295, R14
	MOVQ $-1, R8
	MOVQ $-1, R9
	MOVQ DI, DX
...
LJTI24_0:
	LONG $0xffffff18 // .long L24_0_set_25
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xffffff18 // .long L24_0_set_25
	LONG $0xffffff48 // .long L24_0_set_29
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xfffffefc // .long L24_0_set_23
	LONG $0xfffffefc // .long L24_0_set_23
	LONG $0xfffffefc // .long L24_0_set_23
	LONG $0xfffffefc // .long L24_0_set_23
	LONG $0xfffffefc // .long L24_0_set_23
	...
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xffffff30 // .long L24_0_set_27
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xffffff73 // .long L24_0_set_34
	LONG $0xffffff73 // .long L24_0_set_34
...
_skip_positive:
	...
	SUBQ  BX, SI
	MOVQ  AX, DI
	LONG  $0xfffc43e8; BYTE $0xff // callq        _skip_number
	MOVQ  $-2, CX
	MOVQ  $-2, DX
	SUBQ  AX, DX
	TESTQ AX, AX
...
TEXT ·__f64toa(SB), NOSPLIT, $0 - 24
	MOVQ  out+0(FP), DI
	MOVSD val+8(FP), X0
	CALL  ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+687(SB) // _f64toa
	MOVQ  AX, ret+16(FP)
	RET
...
TEXT ·__i64toa(SB), NOSPLIT, $0 - 24
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+3744(SB) // _i64toa
	MOVQ AX, ret+16(FP)
	RET
...
TEXT ·__lspace(SB), NOSPLIT, $0 - 32
	...
	MOVQ nb+8(FP), SI
	MOVQ off+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+326(SB) // _lspace
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__quote(SB), NOSPLIT, $0 - 48
	...
	MOVQ dn+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+5057(SB) // _quote
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__skip_array(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+19115(SB) // _skip_array
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__skip_object(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+19150(SB) // _skip_object
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__skip_one(SB), NOSPLIT, $0 - 32
	...
	MOVQ p+8(FP), SI
	MOVQ m+16(FP), DX
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16788(SB) // _skip_one
	MOVQ AX, ret+24(FP)
	RET
...
TEXT ·__u64toa(SB), NOSPLIT, $0 - 24
	MOVQ out+0(FP), DI
	MOVQ val+8(FP), SI
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+3837(SB) // _u64toa
	MOVQ AX, ret+16(FP)
	RET
...
TEXT ·__unquote(SB), NOSPLIT, $0 - 48
	...
	MOVQ ep+24(FP), CX
	MOVQ flags+32(FP), R8
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+5990(SB) // _unquote
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__value(SB), NOSPLIT, $0 - 48
	...
	CALL ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+12583(SB) // _value
	MOVQ AX, ret+40(FP)
	RET
...
TEXT ·__vnumber(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+15476(SB), AX // _vnumber
	JMP  AX
...
TEXT ·__vsigned(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16260(SB), AX // _vsigned
	JMP  AX
...
TEXT ·__vstring(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+14203(SB), AX // _vstring
	JMP  AX
...
TEXT ·__vunsigned(SB), NOSPLIT, $0 - 24
	...
	MOVQ p+8(FP), SI
	MOVQ v+16(FP), DX
	LEAQ ·___asm2asm_compiled_code__DO_NOT_CALL_THIS_SYMBOL___+16519(SB), AX // _vunsigned
	JMP  AX
